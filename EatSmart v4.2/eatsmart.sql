...
CREATE TABLE IF NOT EXISTS `menu` (
  ...
  `taille` varchar(50) CHARACTER SET latin1 DEFAULT NULL,
...
(4, 'Double Krunch &copy;', 6, 'M', 'Un burger croustillant avec du fromage, sans tomate, inclus avec boisson et frites.\r\n\r\n', 4, 2),
(5, 'Colonel Original &copy;', 7, 'M', 'Burger avec filet de poulet croustillant et fromage, avec option bacon (+0,50 €), inclus avec boisson et frites.\r\n\r\n', 5, 2),
...
(8, 'Kream Ball &reg;', 2, 'S', 'Crème glacée en coupe.\r\n\r\n', 8, 3),
(9, 'Pom\'Potes &reg; Bio', 2, 'S', 'Compote de pommes bio.\r\n\r\n', 9, 3);
...
--
ALTER TABLE `article`
  ADD CONSTRAINT `idArtCat` FOREIGN KEY (`idCatérogie`) REFERENCES `categorie` (`id`);
...
ALTER TABLE `menu`
  ...
  ADD CONSTRAINT `idMenuCat` FOREIGN KEY (`idCat`) REFERENCES `categorie` (`id`);
COMMIT;
